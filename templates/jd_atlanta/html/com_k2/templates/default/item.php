		...
		<div class="itemImageBlock">
			...
			<span class="itemImage">
				<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
					<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:900px; height:auto;" />
				</a>	
			</span>
	...
	*/
	...
	<div class="itemRelated">
		...
		<div class="span4 <?php echo ($key%2) ? "odd" : "even"; ?>">
			<div class="overlay-image-wrapper">
				<div>
					<a class="overlay-img" href="<?php echo $item->link ?>"><img src="<?php echo $item->imageMedium; ?>" alt="<?php echo $item->title; ?>">
					</a>
					<div class="overlay"></div>
				</div>
			</div>
