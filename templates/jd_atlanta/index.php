...
<link rel="stylesheet" type="text/css" href="templates/<?php echo $templateName; ?>/less/k2.css">
<link rel="stylesheet" type="text/css" href="templates/<?php echo $templateName ;?>/less/jevents.css">
<link rel="stylesheet" type="text/css" href="templates/<?php echo $templateName; ?>/less/responsive.css">
<script src="templates/<?php echo $templateName; ?>/js/custome.js"></script>
...
<body <?php echo $gantry->displayBodyTag(); ?>>
	...
	<div id="jd-copyright">
		<div class="rt-container">
			<div class="rt-block">
				<p>&copy; Copyright <?php echo date('Y'); ?> <?php $config = JFactory::getConfig(); echo $config['sitename']; ?><strong style="text-transform:capitalize;"><a href="https://www.joomdev.com/products/templates" target="_blank"> Joomla Templates</a></strong> by <strong style="text-transform:capitalize;"><a href="http://www.joomdev.com" target="_blank">JoomDev</a></strong></p>
			</div>
		</div>
	</div>
