				...
				<div class="rt-block">
					<div class="rt-error-content">
						...
						<div class="error-content" style="text-align:center;">
							<p><strong>OPPS, SORRY WE CAN'T FIND THAT PAGE!</strong></p>
							<p>Either Something Went Wrong or the page doesn't exist anymore.</p>
							<p>
								<a href="<?php echo $gantry->baseUrl; ?>" class="readon" title="<?php echo JText::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?>"><span><?php echo JText::_('JERROR_LAYOUT_HOME_PAGE'); ?></span></a>
							</p>
						</div>
				</div>
			</div>
