...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/atlanta364?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost/atlanta364?new_link=true');
  }
}
...
$civicrm_root = 'C:\xampp\htdocs\www\administrator\components\com_civicrm\civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\xampp\htdocs\www\media\civicrm\templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/www/administrator/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '1598d5eb2f4b39f0e6971b8b4b629534');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:\xampp\htdocs\www\media\civicrm\templates_c/mail.log');
// }
